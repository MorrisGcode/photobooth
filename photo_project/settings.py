...
SECRET_KEY = 'django-insecure-u@5kvy4z%z#&!koqe$mei#clwk+peoixh5hpe!9m!83pr0qw_6'
...
INSTALLED_APPS = [
    ...
    'photoApp', 
     ...
     # Custom app for photo management
]
...
# cloudinary config
cloudinary.config(
         cloud_name="dgpkztldt",
         api_key="482243957378927",
         api_secret="RfVfrkRkpjVDDBCWj6xs8kswjLM",
         secure=True,
     )
